...
| `network_airgap`                    | When **network_airgap** is set **true**, <br/> - If Bridge exists in the default <Bridge install directory>, it is used. Otherwise, errors out. <br/> - If Bridge exists in the specified Bridge install directory, it is used. Otherwise, errors out. <br/>                                                                 |           
#### Note:
