...
| `network_airgap`                    | When network_airgap is set true, <br/> 1. If Bridge exists in the default <Bridge install directory>, it is used. Otherwise, errors out. <br/>2. If Bridge exists in the specified Bridge install directory, it is used. Otherwise, errors out. <br/>                                                                        |           
#### Note:
