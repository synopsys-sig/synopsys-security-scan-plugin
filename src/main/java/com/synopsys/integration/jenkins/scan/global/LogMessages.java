...
public class LogMessages {
    ...
    public static final String INVALID_BRIDGE_DOWNLOAD_URL_PROVIDED = "The provided Bridge download URL is not valid: %s";
    ...
    public static final String INVALID_SYNOPSYS_SECURITY_PLATFORM = "Invalid Synopsys Security Platform!";
}
